...
fun CepScreen(modifier: Modifier = Modifier) {
    ...
    var listaEnderecos by remember { mutableStateOf(listOf<Endereco>()) }
...
// pesquisa por cep
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    //pesquisar por uf cidade e rua
                    IconButton(onClick = {
                        val call = RetrofitFactory().getEnderecoService().getEnderecoByUfCidadeRua(
                            uf = ufState,
                            cidade = cidadeState,
                            rua = ruaState
                        )
